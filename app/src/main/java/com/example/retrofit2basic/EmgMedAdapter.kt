...
class EmgMedAdapter :androidx.recyclerview.widget.ListAdapter<Row, EmgMedAdapter.EmgMedViewHolder>(EmgmedCallback){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EmgMedViewHolder {
        val binding : ItemEmgmedBinding = ItemEmgmedBinding.inflate(LayoutInflater.from(parent.context), parent,false)
    ...
    companion object{
        private val EmgmedCallback : DiffUtil.ItemCallback<Row> = object  : DiffUtil.ItemCallback<Row>(){
